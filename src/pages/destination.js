        ...
        <div className="w-full flex flex-col lg:flex-row items-center justify-evenly">
          <Link className="country-link" to="/indian-subcontinent/">
            <div className="country grid max-w-sm m-10 md:m-6">
              ...
              >
                <h1 className="country-name palanquin-bold text-white text-3xl xl:text-4xl tracking-widest text-center">
                  INDIAN SUBCONTINENT
                </h1>
              </div>
            </div>
          ...
          <Link className="country-link" to="/south-east-asia/">
            <div className="country grid max-w-sm m-10 md:m-6">
              ...
              >
                <h1 className="country-name palanquin-bold text-white text-center text-3xl xl:text-4xl tracking-wider text-shadow">
          ...
          <Link className="country-link" to="/china/">
            <div className="country grid max-w-sm m-10 md:m-6">
              ...
              >
                <h1 className="country-name palanquin-bold text-3xl xl:text-4xl tracking-widest text-red-600">
                  CHINA
                </h1>
              </div>
            </div>
          ...
          <Link className="country-link" to="/mongolia/">
            <div className="country grid max-w-sm m-10 md:m-6">
              ...
              >
                <h1 className="country-name palanquin-bold text-3xl xl:text-4xl tracking-widest text-white">
                  MONGOLIA
                </h1>
              </div>
            </div>
